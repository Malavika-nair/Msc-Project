...
{
	$.ajax({type: 'POST',
 		 url: "http://localhost:7001/com.sheltonmachines.service/api/manage/display/parameters/",
          cache: false,
...
$(document).ready(function() {
	...
	function saveRow ( pTable, nRow )
	{
	  ...
	  //  pTable.fnUpdate( jqInputs[0].value, nRow, 0, false );
	    ...
	    ajaxObj = {  
				type: "PUT",
				url: "http://localhost:7001/com.sheltonmachines.service/api/manage/display/parameters/" + id + "/" + jqInputs[0].value+  "/" + jqInputs[1].value, 
				cache: false,
				success: function(data) {
					//console.log(data);
					alert( data[0].MSG );
